 ...
 * Deskripsi : Implementasi GUI Complex dengan mengimplementasikan beberapa button dan implementasi type data set, map, dan list
...
public class GuiComplex extends javax.swing.JFrame {
    ...
    // Pada Set data disimpan secara unik yaitu tidak boleh ada data dengan nilai yang sama jika sama maka tidak akan ditambahkan ke koleksi set
